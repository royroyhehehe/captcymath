    ...
    <div class="container">
        <form method="POST" action="proses.php" enctype="multipart/form-data">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                <input required type="text" name="nisn" class="form-control" id="nisn" placeholder="Ex: 202410001" value="<?php echo $nisn ?>">
                </div>
            </div>
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                <input required type="text" name="nama_siswa" class="form-control" id="nama" placeholder="Ex: Royan" value="<?php echo $nama_siswa ?>">
                </div>
            </div>
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                <select value="<?php echo $jenis_kelamin ?>" required id="jkel" name="jenis_kelamin" class="form-select">
